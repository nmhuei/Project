...
from pw8.domains.SystemManagementMark import SystemManagementMark
...
class OutputUI:
    ...
    def draw_exit(self, stdscr):
        stdscr.clear()
        message = "GOOD BYE. SEE YOU NEXT TIME ....."
        stdscr.addstr(self.height // 2, (self.width - len(message)) // 2, message)
        stdscr.refresh()
    ...
    def hander_add_student(self, stdscr):
        ...
        # On success, show confirmation message at a fixed row
        confirm_row = 7
        stdscr.addstr(confirm_row, 4, "Press any key to continue...")
