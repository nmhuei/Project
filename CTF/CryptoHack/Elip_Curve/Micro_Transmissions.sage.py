...
def find_n(P, Q):
    ...
    moduli = []
    remainders = []
    for i in fac[_sage_const_0 :-_sage_const_2 ]:
        P0 = P*ZZ(P.order()/(i[_sage_const_0 ]**i[_sage_const_1 ]))
        Q0 = Q*ZZ(P.order()/(i[_sage_const_0 ]**i[_sage_const_1 ]))
